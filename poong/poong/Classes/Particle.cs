...
//Thos whole particle class / engine is taken from the http://rbwhitaker.wikidot.com/2d-particle-engine-2 site
...
namespace poong
{
    public class Particle
    {
        ...
        {
            //Rectangle covers the whole texture
